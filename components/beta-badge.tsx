    ...
    return (
      <div className={`relative inline-block ${className}`}>
        <button
          ...
          className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-orange-500/20 border border-orange-500/40 text-orange-500 hover:bg-orange-500/30 hover:border-orange-500/60 hover:scale-110 transition-all cursor-pointer"
        ...
        {showTooltip && (
          ...
          >
            <div className="bg-gray-900 dark:bg-gray-900 border border-orange-500/50 rounded-lg shadow-xl px-3 py-2 text-xs whitespace-nowrap backdrop-blur-sm">
              <div className="font-semibold text-orange-400 mb-1">beta</div>
